...
fn call_kinds_capture_dispatch() {
    ...
    let builtin = ExprKind::Call {
        kind: CallKind::Builtin(Builtin::Panic),
        args: vec![arg()],
        callee_span: cs,
        callee_ty: t,
    };
...
fn intrinsics_cover_every_retired_marker_table() {
    ...
    let kinds = vec![
        ...
        Intrinsic::TimeSleep,
        Intrinsic::IoStdinReadAsync,
        Intrinsic::IoStdinReadToEndAsync,
        Intrinsic::IoStdoutWriteAsync,
        Intrinsic::IoStderrWriteAsync,
        Intrinsic::IoStdoutFlushAsync,
        Intrinsic::IoStderrFlushAsync,
        Intrinsic::FsReadTextAsync,
        Intrinsic::FsWriteTextAsync,
        Intrinsic::FsAppendTextAsync,
        Intrinsic::FsReadBytesAsync,
        Intrinsic::FsWriteBytesAsync,
        Intrinsic::FsExistsAsync,
        Intrinsic::FsIsFileAsync,
        Intrinsic::FsIsDirAsync,
        Intrinsic::FsKindAsync,
        Intrinsic::FsLenAsync,
        Intrinsic::FsReadOnlyAsync,
        Intrinsic::FsExecutableAsync,
        Intrinsic::FsRemoveAsync,
        Intrinsic::FsRenameAsync,
        Intrinsic::FsCreateDirAsync,
        Intrinsic::FsCreateDirAllAsync,
        Intrinsic::FsCanonicalizeAsync,
        Intrinsic::FsReadDirAsync,
        Intrinsic::FsFileOpenAsync,
        Intrinsic::FsFileCloseAsync,
        Intrinsic::FsFileReadAsync,
        Intrinsic::FsFileReadToEndAsync,
        Intrinsic::FsFileWriteAsync,
        Intrinsic::FsFileFlushAsync,
        Intrinsic::FsFileSeekAsync,
        Intrinsic::RandOsBytesAsync,
        Intrinsic::ProcessArgsAsync,
        Intrinsic::ProcessEnvAsync,
        Intrinsic::ProcessEnvAllAsync,
        Intrinsic::ProcessSetEnvAsync,
        Intrinsic::ProcessStatusAsync,
        Intrinsic::ProcessOutputAsync,
        Intrinsic::ProcessSpawnAsync,
        Intrinsic::ProcessChildWaitAsync,
        Intrinsic::ProcessChildKillAsync,
        Intrinsic::NetResolveAsync,
        Intrinsic::NetTcpConnectAsync,
        Intrinsic::NetTcpConnectTimeoutAsync,
        Intrinsic::NetTcpStreamReadAsync,
        Intrinsic::NetTcpStreamReadToEndAsync,
        Intrinsic::NetTcpStreamWriteAsync,
        Intrinsic::NetTcpStreamWriteAllAsync,
        Intrinsic::NetTcpStreamFlushAsync,
        Intrinsic::NetTcpStreamPeekAsync,
        Intrinsic::NetTcpStreamCloseAsync,
        Intrinsic::NetTcpStreamPeerAddrAsync,
        Intrinsic::NetTcpStreamLocalAddrAsync,
        Intrinsic::NetTcpStreamTakeErrorAsync,
        Intrinsic::NetTcpStreamNodelayAsync,
        Intrinsic::NetTcpStreamSetNodelayAsync,
        Intrinsic::NetTcpStreamSetNonblockingAsync,
        Intrinsic::NetTcpStreamReadTimeoutAsync,
        Intrinsic::NetTcpStreamSetReadTimeoutAsync,
        Intrinsic::NetTcpStreamWriteTimeoutAsync,
        Intrinsic::NetTcpStreamSetWriteTimeoutAsync,
        Intrinsic::NetTcpStreamTtlAsync,
        Intrinsic::NetTcpStreamSetTtlAsync,
        Intrinsic::NetTcpListenerBindAsync,
        Intrinsic::NetTcpListenerCloseAsync,
        Intrinsic::NetTcpListenerAcceptAsync,
        Intrinsic::NetTcpListenerLocalAddrAsync,
        Intrinsic::NetTcpListenerTakeErrorAsync,
        Intrinsic::NetTcpListenerSetNonblockingAsync,
        Intrinsic::NetTcpListenerTtlAsync,
        Intrinsic::NetTcpListenerSetTtlAsync,
        Intrinsic::NetUdpSendAsync,
        Intrinsic::NetUdpRecvAsync,
        Intrinsic::NetUdpPeekAsync,
        Intrinsic::NetUdpSendToAsync,
        Intrinsic::NetUdpRecvFromAsync,
        Intrinsic::NetUdpPeekFromAsync,
        Intrinsic::NetUdpBindAsync,
        Intrinsic::NetUdpCloseAsync,
        Intrinsic::NetUdpConnectAsync,
        Intrinsic::NetUdpLocalAddrAsync,
        Intrinsic::NetUdpPeerAddrAsync,
        Intrinsic::NetUdpTakeErrorAsync,
        Intrinsic::NetUdpSetNonblockingAsync,
        Intrinsic::NetUdpReadTimeoutAsync,
        Intrinsic::NetUdpSetReadTimeoutAsync,
        Intrinsic::NetUdpWriteTimeoutAsync,
        Intrinsic::NetUdpSetWriteTimeoutAsync,
        Intrinsic::NetUdpTtlAsync,
        Intrinsic::NetUdpSetTtlAsync,
        Intrinsic::NetUdpBroadcastAsync,
        Intrinsic::NetUdpSetBroadcastAsync,
        Intrinsic::NetUdpMulticastLoopV4Async,
        Intrinsic::NetUdpSetMulticastLoopV4Async,
        Intrinsic::NetUdpMulticastLoopV6Async,
        Intrinsic::NetUdpSetMulticastLoopV6Async,
        Intrinsic::NetUdpMulticastTtlV4Async,
        Intrinsic::NetUdpSetMulticastTtlV4Async,
        Intrinsic::NetUdpJoinMulticastV4Async,
        Intrinsic::NetUdpLeaveMulticastV4Async,
        Intrinsic::NetUdpJoinMulticastV6Async,
        Intrinsic::NetUdpLeaveMulticastV6Async,
        Intrinsic::TimeMonotonicNanosAsync,
        Intrinsic::TimeSystemNanosAsync,
        Intrinsic::TimeLocalOffsetSecondsAsync,
