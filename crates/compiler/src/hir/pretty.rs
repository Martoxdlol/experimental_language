...
fn driver_str(d: &ForDriver) -> &'static str {
    match d {
        ...
        ForDriver::ChannelAsync { .. } => "/channel-async",
...
fn intrinsic_str(i: &Intrinsic) -> &'static str {
    match i {
        ...
        Intrinsic::TimeSleep => "time-sleep",
        ...
        Intrinsic::FsReadTextAsync => "fs-read-text-async",
        Intrinsic::FsWriteTextAsync => "fs-write-text-async",
        Intrinsic::FsAppendTextAsync => "fs-append-text-async",
        Intrinsic::FsReadBytesAsync => "fs-read-bytes-async",
        Intrinsic::FsWriteBytesAsync => "fs-write-bytes-async",
        Intrinsic::FsExistsAsync => "fs-exists-async",
        Intrinsic::FsIsFileAsync => "fs-is-file-async",
        Intrinsic::FsIsDirAsync => "fs-is-dir-async",
        Intrinsic::FsKindAsync => "fs-kind-async",
        Intrinsic::FsLenAsync => "fs-len-async",
        Intrinsic::FsReadOnlyAsync => "fs-read-only-async",
        Intrinsic::FsExecutableAsync => "fs-executable-async",
        Intrinsic::FsRemoveAsync => "fs-remove-async",
        Intrinsic::FsRenameAsync => "fs-rename-async",
        Intrinsic::FsCreateDirAsync => "fs-create-dir-async",
        Intrinsic::FsCreateDirAllAsync => "fs-create-dir-all-async",
        Intrinsic::FsCanonicalizeAsync => "fs-canonicalize-async",
        Intrinsic::FsReadDirAsync => "fs-read-dir-async",
        Intrinsic::FsFileOpenAsync => "fs-file-open-async",
        Intrinsic::FsFileCloseAsync => "fs-file-close-async",
        Intrinsic::FsFileReadAsync => "fs-file-read-async",
        Intrinsic::FsFileReadToEndAsync => "fs-file-read-to-end-async",
        Intrinsic::FsFileWriteAsync => "fs-file-write-async",
        Intrinsic::FsFileFlushAsync => "fs-file-flush-async",
        Intrinsic::FsFileSeekAsync => "fs-file-seek-async",
        Intrinsic::RandOsBytesAsync => "rand-os-bytes-async",
        Intrinsic::ProcessArgsAsync => "process-args-async",
        Intrinsic::ProcessEnvAsync => "process-env-async",
        Intrinsic::ProcessEnvAllAsync => "process-env-all-async",
        Intrinsic::ProcessSetEnvAsync => "process-set-env-async",
        Intrinsic::ProcessStatusAsync => "process-status-async",
        Intrinsic::ProcessOutputAsync => "process-output-async",
        Intrinsic::ProcessSpawnAsync => "process-spawn-async",
        Intrinsic::ProcessChildWaitAsync => "process-child-wait-async",
        Intrinsic::ProcessChildKillAsync => "process-child-kill-async",
        Intrinsic::NetResolveAsync => "net-resolve-async",
        Intrinsic::NetTcpConnectAsync => "net-tcp-connect-async",
        Intrinsic::NetTcpConnectTimeoutAsync => "net-tcp-connect-timeout-async",
        Intrinsic::NetTcpStreamReadAsync => "net-tcp-stream-read-async",
        Intrinsic::NetTcpStreamReadToEndAsync => "net-tcp-stream-read-to-end-async",
        Intrinsic::NetTcpStreamWriteAsync => "net-tcp-stream-write-async",
        Intrinsic::NetTcpStreamWriteAllAsync => "net-tcp-stream-write-all-async",
        Intrinsic::NetTcpStreamFlushAsync => "net-tcp-stream-flush-async",
        Intrinsic::NetTcpStreamPeekAsync => "net-tcp-stream-peek-async",
        Intrinsic::NetTcpStreamCloseAsync => "net-tcp-stream-close-async",
        Intrinsic::NetTcpStreamPeerAddrAsync => "net-tcp-stream-peer-addr-async",
        Intrinsic::NetTcpStreamLocalAddrAsync => "net-tcp-stream-local-addr-async",
        Intrinsic::NetTcpStreamTakeErrorAsync => "net-tcp-stream-take-error-async",
        Intrinsic::NetTcpStreamNodelayAsync => "net-tcp-stream-nodelay-async",
        Intrinsic::NetTcpStreamSetNodelayAsync => "net-tcp-stream-set-nodelay-async",
        Intrinsic::NetTcpStreamSetNonblockingAsync => "net-tcp-stream-set-nonblocking-async",
        Intrinsic::NetTcpStreamReadTimeoutAsync => "net-tcp-stream-read-timeout-async",
        Intrinsic::NetTcpStreamSetReadTimeoutAsync => "net-tcp-stream-set-read-timeout-async",
        Intrinsic::NetTcpStreamWriteTimeoutAsync => "net-tcp-stream-write-timeout-async",
        Intrinsic::NetTcpStreamSetWriteTimeoutAsync => "net-tcp-stream-set-write-timeout-async",
        Intrinsic::NetTcpStreamTtlAsync => "net-tcp-stream-ttl-async",
        Intrinsic::NetTcpStreamSetTtlAsync => "net-tcp-stream-set-ttl-async",
        Intrinsic::NetTcpListenerBindAsync => "net-tcp-listener-bind-async",
        Intrinsic::NetTcpListenerCloseAsync => "net-tcp-listener-close-async",
        Intrinsic::NetTcpListenerAcceptAsync => "net-tcp-listener-accept-async",
        Intrinsic::NetTcpListenerLocalAddrAsync => "net-tcp-listener-local-addr-async",
        Intrinsic::NetTcpListenerTakeErrorAsync => "net-tcp-listener-take-error-async",
        Intrinsic::NetTcpListenerSetNonblockingAsync => "net-tcp-listener-set-nonblocking-async",
        Intrinsic::NetTcpListenerTtlAsync => "net-tcp-listener-ttl-async",
        Intrinsic::NetTcpListenerSetTtlAsync => "net-tcp-listener-set-ttl-async",
        Intrinsic::NetUdpSendAsync => "net-udp-send-async",
        Intrinsic::NetUdpRecvAsync => "net-udp-recv-async",
        Intrinsic::NetUdpPeekAsync => "net-udp-peek-async",
        Intrinsic::NetUdpSendToAsync => "net-udp-send-to-async",
        Intrinsic::NetUdpRecvFromAsync => "net-udp-recv-from-async",
        Intrinsic::NetUdpPeekFromAsync => "net-udp-peek-from-async",
        Intrinsic::NetUdpBindAsync => "net-udp-bind-async",
        Intrinsic::NetUdpCloseAsync => "net-udp-close-async",
        Intrinsic::NetUdpConnectAsync => "net-udp-connect-async",
        Intrinsic::NetUdpLocalAddrAsync => "net-udp-local-addr-async",
        Intrinsic::NetUdpPeerAddrAsync => "net-udp-peer-addr-async",
        Intrinsic::NetUdpTakeErrorAsync => "net-udp-take-error-async",
        Intrinsic::NetUdpSetNonblockingAsync => "net-udp-set-nonblocking-async",
        Intrinsic::NetUdpReadTimeoutAsync => "net-udp-read-timeout-async",
        Intrinsic::NetUdpSetReadTimeoutAsync => "net-udp-set-read-timeout-async",
        Intrinsic::NetUdpWriteTimeoutAsync => "net-udp-write-timeout-async",
        Intrinsic::NetUdpSetWriteTimeoutAsync => "net-udp-set-write-timeout-async",
        Intrinsic::NetUdpTtlAsync => "net-udp-ttl-async",
        Intrinsic::NetUdpSetTtlAsync => "net-udp-set-ttl-async",
        Intrinsic::NetUdpBroadcastAsync => "net-udp-broadcast-async",
        Intrinsic::NetUdpSetBroadcastAsync => "net-udp-set-broadcast-async",
        Intrinsic::NetUdpMulticastLoopV4Async => "net-udp-multicast-loop-v4-async",
        Intrinsic::NetUdpSetMulticastLoopV4Async => "net-udp-set-multicast-loop-v4-async",
        Intrinsic::NetUdpMulticastLoopV6Async => "net-udp-multicast-loop-v6-async",
        Intrinsic::NetUdpSetMulticastLoopV6Async => "net-udp-set-multicast-loop-v6-async",
        Intrinsic::NetUdpMulticastTtlV4Async => "net-udp-multicast-ttl-v4-async",
        Intrinsic::NetUdpSetMulticastTtlV4Async => "net-udp-set-multicast-ttl-v4-async",
        Intrinsic::NetUdpJoinMulticastV4Async => "net-udp-join-multicast-v4-async",
        Intrinsic::NetUdpLeaveMulticastV4Async => "net-udp-leave-multicast-v4-async",
        Intrinsic::NetUdpJoinMulticastV6Async => "net-udp-join-multicast-v6-async",
        Intrinsic::NetUdpLeaveMulticastV6Async => "net-udp-leave-multicast-v6-async",
        Intrinsic::TimeMonotonicNanosAsync => "time-monotonic-nanos-async",
        Intrinsic::TimeSystemNanosAsync => "time-system-nanos-async",
        Intrinsic::TimeLocalOffsetSecondsAsync => "time-local-offset-seconds-async",
